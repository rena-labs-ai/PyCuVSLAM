"""Generic cuVSLAM tracking pipeline.

Delegates camera-specific logic to a BaseTracker and owns the shared state:
the result queue, the vslam.Tracker instance, and the odometry config. Pure
logic — no ROS dependency.
"""
